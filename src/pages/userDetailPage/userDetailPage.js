...
import { ThumPage, ThumTitle,ThumText,ThumImg,ThumP,ThumSpan,ThumFoot,Button,ThumMadalButton } from '../../components/DetailPage/DetailPageCss';
  ...
  return (
    <ThumPage>
      ...
      <ThumFoot>
          ...
          <ThumMadalButton backcolor='#4F85EB' color ='white'>거절</ThumMadalButton>
      </ThumFoot>
    </ThumPage>
